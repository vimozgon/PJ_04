...
const MainPage = () => {
  document.title = 'Сервис поиска публикаций о компании по ее ИНН — СКАН';
    ...
    <MainLayout>
      <section className={styles.hero}>
        <div className={styles.hero__text}>
          <h1>Сервис поиска публикаций о компании по ее ИНН</h1>

          <p className={styles.hero__desc}>
            Всесторонний анализ публикаций, получение данных в формате PDF на
            электронную почту.
          </p>
